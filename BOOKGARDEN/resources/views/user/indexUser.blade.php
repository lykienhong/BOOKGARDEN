...
Danh sách thể loại
    ...
    @foreach($cate as $i) 
    @if($i->visible==0)
    <p  class="col"><a class="dropdown-item border-end border-2 " id="item" href="{{"searchCates/$i->cateId"}}">{{$i->cateName}}</a></p>
@endif
    @endforeach
    </div>
...
<div class="row">
    <div class="col-3 "><img width="100%" src="https://www.giaoduc.edu.vn/upload/images/2020/07/31/hiem-sach-thieu-nhi-cua-tac-gia-trong-nuoc-1.jpg" onclick=window.location.href="{{url('#section')}}"></div>
    <div class="col-3"><img width="100%" height="95%" src="https://bloganchoi.com/wp-content/uploads/2019/05/sach-thieu-nhi-hay-7.jpg" onclick=window.location.href="{{url('#section')}}"></div>
    <div class="col-3"><img width="100%" src="https://cth.edu.vn/wp-content/uploads/2018/01/sachtiengAnhCTmoi-1280x720.jpg" onclick=window.location.href="{{url('#section')}}"></div>
    <div class="col-3"><img  width="100%" height="95%" src="https://static.tuoitre.vn/tto/i/s626/2016/05/26/3809ad4d.jpg" onclick=window.location.href="{{url('#section')}}"></div>
</div>
