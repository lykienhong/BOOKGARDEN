...
<body>
    ...
    @section('title', 'process status - update new')
    @section('content')
                ...
                <div class="row">
                    <div class="offset-md-3 col-md-6">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="{{ url('sale-assistant/sale_assistant_post_update_process/'.$orders->orderId) }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
