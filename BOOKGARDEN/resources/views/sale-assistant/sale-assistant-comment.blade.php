...
<body>
    ...
    @section('title', 'sale-assistant users comment')
    @section('content')
                        ...
                        <div class="card-body">
                            <table id="product" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $co->comment}}</td>
                                    <td class="text-right">
                                        <a class="btn btn-info btn-sm" href="{{ url('sale-assistant/sale_assistant_delete_comment/'.$co->commentId) }}" onclick="return confirm('Có chắc chắn muốn xóa ?')">
